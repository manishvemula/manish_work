...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdHttpDnsRetryInterval = _PCD_VALUE_PcdHttpDnsRetryInterval;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdHttpDnsRetryCount = _PCD_VALUE_PcdHttpDnsRetryCount;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdHttpTransferBufferSize = _PCD_VALUE_PcdHttpTransferBufferSize;
