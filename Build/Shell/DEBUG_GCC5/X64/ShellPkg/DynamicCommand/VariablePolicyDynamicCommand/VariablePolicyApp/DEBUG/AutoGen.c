...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xCA3D995F, 0x3291, 0x45AF, {0xB5, 0x0A, 0x7C, 0x8A, 0xE5, 0x84, 0xD8, 0x57}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "varpolicy";
...
{
  return VariablePolicyAppInitialize (ImageHandle, SystemTable);
}
