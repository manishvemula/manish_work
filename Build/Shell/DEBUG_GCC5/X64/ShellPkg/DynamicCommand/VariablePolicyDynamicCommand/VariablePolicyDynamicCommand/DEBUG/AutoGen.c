...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x17D0EF2A, 0x5933, 0x4007, {0x89, 0x50, 0x57, 0x49, 0x16, 0x9D, 0x3D, 0xC5}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VariablePolicyDynamicCommand";
...
{
  return VariablePolicyDynamicCommandEntryPoint (ImageHandle, SystemTable);
}
...
{
  return VariablePolicyDynamicCommandUnload (ImageHandle);
}
