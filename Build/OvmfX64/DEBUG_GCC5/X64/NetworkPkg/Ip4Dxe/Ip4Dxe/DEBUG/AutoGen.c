...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEntryPointOverrideFwCfgVarName[30] = {111, 112, 116, 47, 111, 114, 103, 46, 116, 105, 97, 110, 111, 99, 111, 114, 101, 47, 73, 80, 118, 52, 83, 117, 112, 112, 111, 114, 116, 0 };
extern const UINT8 _gPcd_FixedAtBuild_PcdEntryPointOverrideFwCfgVarName[30];
#define _PCD_GET_MODE_PTR_PcdEntryPointOverrideFwCfgVarName  _gPcd_FixedAtBuild_PcdEntryPointOverrideFwCfgVarName
#define _PCD_SIZE_PcdEntryPointOverrideFwCfgVarName 30
#define _PCD_GET_MODE_SIZE_PcdEntryPointOverrideFwCfgVarName  _PCD_SIZE_PcdEntryPointOverrideFwCfgVarName 
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdEntryPointOverrideFwCfgVarName = 30;
