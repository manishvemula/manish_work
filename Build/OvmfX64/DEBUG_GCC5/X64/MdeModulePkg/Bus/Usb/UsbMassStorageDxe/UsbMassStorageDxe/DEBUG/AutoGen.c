...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEntryPointOverrideFwCfgVarName[36] = {111, 112, 116, 47, 111, 114, 103, 46, 116, 105, 97, 110, 111, 99, 111, 114, 101, 47, 85, 115, 98, 83, 116, 111, 114, 97, 103, 101, 83, 117, 112, 112, 111, 114, 116, 0 };
extern const UINT8 _gPcd_FixedAtBuild_PcdEntryPointOverrideFwCfgVarName[36];
#define _PCD_GET_MODE_PTR_PcdEntryPointOverrideFwCfgVarName  _gPcd_FixedAtBuild_PcdEntryPointOverrideFwCfgVarName
#define _PCD_SIZE_PcdEntryPointOverrideFwCfgVarName 36
#define _PCD_GET_MODE_SIZE_PcdEntryPointOverrideFwCfgVarName  _PCD_SIZE_PcdEntryPointOverrideFwCfgVarName 
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdEntryPointOverrideFwCfgVarName = 36;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEntryPointOverrideDefaultValue[4] = {121, 101, 115, 0 };
extern const UINT8 _gPcd_FixedAtBuild_PcdEntryPointOverrideDefaultValue[4];
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdEntryPointOverrideDefaultValue = 4;
