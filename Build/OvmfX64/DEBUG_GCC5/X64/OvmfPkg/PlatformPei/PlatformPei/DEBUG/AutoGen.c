...
#define _PCD_TOKEN_PcdOvmfEarlyMemDebugLogBase  0U
#define _PCD_SIZE_PcdOvmfEarlyMemDebugLogBase 4
#define _PCD_GET_MODE_SIZE_PcdOvmfEarlyMemDebugLogBase  _PCD_SIZE_PcdOvmfEarlyMemDebugLogBase 
#define _PCD_VALUE_PcdOvmfEarlyMemDebugLogBase  0x008F0000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdOvmfEarlyMemDebugLogBase = _PCD_VALUE_PcdOvmfEarlyMemDebugLogBase;
extern const  UINT32  _gPcd_FixedAtBuild_PcdOvmfEarlyMemDebugLogBase;
#define _PCD_GET_MODE_32_PcdOvmfEarlyMemDebugLogBase  _gPcd_FixedAtBuild_PcdOvmfEarlyMemDebugLogBase
//#define _PCD_SET_MODE_32_PcdOvmfEarlyMemDebugLogBase  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD

#define _PCD_TOKEN_PcdOvmfEarlyMemDebugLogSize  0U
#define _PCD_SIZE_PcdOvmfEarlyMemDebugLogSize 4
#define _PCD_GET_MODE_SIZE_PcdOvmfEarlyMemDebugLogSize  _PCD_SIZE_PcdOvmfEarlyMemDebugLogSize 
#define _PCD_VALUE_PcdOvmfEarlyMemDebugLogSize  0x00010000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdOvmfEarlyMemDebugLogSize = _PCD_VALUE_PcdOvmfEarlyMemDebugLogSize;
extern const  UINT32  _gPcd_FixedAtBuild_PcdOvmfEarlyMemDebugLogSize;
#define _PCD_GET_MODE_32_PcdOvmfEarlyMemDebugLogSize  _gPcd_FixedAtBuild_PcdOvmfEarlyMemDebugLogSize
//#define _PCD_SET_MODE_32_PcdOvmfEarlyMemDebugLogSize  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
