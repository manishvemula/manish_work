...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xF141B1E5, 0x9C7C, 0x44CC, {0xAF, 0xAA, 0xE8, 0x7D, 0x76, 0x89, 0xB1, 0x13}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VirtioKeyboardDxe";
...
{
  return VirtioKeyboardEntryPoint (ImageHandle, SystemTable);
}
