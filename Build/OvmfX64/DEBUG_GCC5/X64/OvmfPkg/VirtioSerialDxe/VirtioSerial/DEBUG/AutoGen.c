...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x23CACE14, 0xEBA4, 0x49F6, {0x96, 0x81, 0xC6, 0x97, 0xFF, 0x0B, 0x64, 0x9E}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VirtioSerialDxe";
...
{
  return VirtioSerialEntryPoint (ImageHandle, SystemTable);
}
