...
/***************************
*  QemuDebugCon.asm --END  *
***************************/

%else

/******************************
*  DebugDisabled.asm --START  *
******************************/
;------------------------------------------------------------------------------
; @file
; Debug disabled
...
/**************************************
*  Ia32/SearchForBfvBase.asm --START  *
**************************************/
;------------------------------------------------------------------------------
; @file
...
/************************************
*  Ia32/SearchForBfvBase.asm --END  *
************************************/


/***************************************
*  Ia32/SearchForSecEntry.asm --START  *
***************************************/
;------------------------------------------------------------------------------
; @file
...
/*************************************
*  Ia32/SearchForSecEntry.asm --END  *
*************************************/
...
/*************************************
*  X64/IntelTdxMetadata.asm --START  *
*************************************/
;------------------------------------------------------------------------------
; @file
...
/***********************************
*  X64/IntelTdxMetadata.asm --END  *
***********************************/


/************************************
*  Ia32/Flat32ToFlat64.asm --START  *
************************************/
;------------------------------------------------------------------------------
; @file
...
/**********************************
*  Ia32/Flat32ToFlat64.asm --END  *
**********************************/


/**********************************
*  Ia32/PageTables64.asm --START  *
**********************************/
;------------------------------------------------------------------------------
; @file
...
/********************************
*  Ia32/PageTables64.asm --END  *
********************************/


/******************************
*  Ia32/IntelTdx.asm --START  *
******************************/
;------------------------------------------------------------------------------
; @file
;   Intel TDX routines
...
/****************************
*  Ia32/IntelTdx.asm --END  *
****************************/


/************************************
*  X64/OvmfSevMetadata.asm --START  *
************************************/
;-----------------------------------------------------------------------------
; @file
...
/**********************************
*  Ia16/Real16ToFlat32.asm --END  *
**********************************/


/****************************
*  Ia16/Init16.asm --START  *
****************************/
;------------------------------------------------------------------------------
; @file
...
/*************************************
*  Ia16/ResetVectorVtf0.asm --START  *
*************************************/
;------------------------------------------------------------------------------
; @file
