...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x60740CF3, 0xD428, 0x4500, {0x80, 0xE6, 0x04, 0xA5, 0x79, 0x82, 0x41, 0xED}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VirtHstiDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAdapterInfoPlatformSecurityGuid = {0x6be272c7, 0x1320, 0x4ccd, { 0x90, 0x17, 0xd4, 0x61, 0x2c, 0x01, 0x2b, 0x25 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdBfvBase = _PCD_VALUE_PcdBfvBase;
...
{
  return VirtHstiDxeEntrypoint (ImageHandle, SystemTable);
}
